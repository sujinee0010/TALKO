    ...
    <div class="container marketing">
     ...
     <hr>
      <div class="">
        ...
        <table class="table">
        <tr>
        <td><p class="join_table"><a href="join_student.jsp"><img src="images/student.png" align="middle" width ="150" height="150" /></a></p></td>
        <td><p class="join_table"><a href="join_teacher.jsp"><img src="images/teacher3.jpg" align="middle" width ="150" height="150" /></a></p></td>
        </tr>
        <tr>
         <td class="join_table">학생</td>
         <td class ="join_table">선생님</td>
        </tr>
        </table> 
      </div>

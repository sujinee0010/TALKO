  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <% 
        	 ...
        	 %> 
        	  <a class="navbar-brand" > <%=name%>님 반갑습니다  </a>
    ...
    <div class="container marketing">
      ...
      <tr>
     	...
     	<tr>
      	<td> 경력 및 학력   </td>
      	<td><textarea name="career" style=" width:100%; height:40px;   overflow-y:hidden; background:clear;"><%=user.getCareer()%></textarea></td>
      	</tr>
      	<tr>
      	<td> 간단 소개글  </td>
      	<td><textarea name="introduce" style=" width:100%; height:40px;   overflow-y:hidden; background:clear;"><%=user.getIntroduce()%></textarea></td>
      	</tr>
      	</table>
